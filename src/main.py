...
def main():
    ...
    parser.add_argument('--input-file-path', type=str, required=True, help="Input file containing VPC flow logs.")
    parser.add_argument('--output-dir-path', type=str, required=True, help="The directory path where the output files would be saved.")
